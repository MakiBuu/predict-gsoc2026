...
class COCAProcessor:
    def __init__(self, project_root: str):
        ...
        self.dicom_root = self.project_root / "cocacoronarycalciumandchestcts-2" / "data" / "Gated_release_final" / "patient"
        self.xml_root = self.project_root / "cocacoronarycalciumandchestcts-2" / "data" / "Gated_release_final" / "calcium_xml"
...
if __name__ == "__main__":
    ...
    processor = COCAProcessor(r"C:\Users\level\OneDrive\Escritorio\COCA")
